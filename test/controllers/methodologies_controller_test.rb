...
class MethodologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create methodology" do
    assert_difference('Methodology.count') do
      post methodologies_url, params: { methodology: { description: @methodology.description, insertTime: @methodology.insertTime, name: @methodology.name } }
    end
  ...
  test "should update methodology" do
    patch methodology_url(@methodology), params: { methodology: { description: @methodology.description, insertTime: @methodology.insertTime, name: @methodology.name } }
